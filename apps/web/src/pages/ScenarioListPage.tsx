...
import { useScenarios, useCreateScenario } from '@/lib/hooks';
    ...
    <div>
      ...
      {showForm && (
        <form onSubmit={handleCreate} className="bg-white p-4 rounded-lg shadow mb-4 grid grid-cols-2 gap-3">
          ...
          <button type="submit" disabled={createScenario.isPending} className="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 disabled:opacity-50">
